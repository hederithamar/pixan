                    ...
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               <div class="form-group row">
                                    <div class="col-md-6">
                                        {{ html()->label(__('validation.attributes.backend.access.furniture.lat'))->class('col-md-12 form-control-label')->for('lat') }}
                                    ...
                                    <div class="col-md-6">
                                        {{ html()->label(__('validation.attributes.backend.access.furniture.lng'))->class('col-md-12 form-control-label')->for('lng') }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                    <div class="form-group">
                                        {{ html()->label(__('validation.attributes.backend.access.furniture.image'))->for('image') }}
