                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="sub_category" id="sub_category" class="js-example-responsive " required="required">
                                        ...
                                        <option value="Muebles de caja">Muebles de caja</option>
                                        <option value="Muebles de tabla">Muebles de tabla</option>
                                        <option value="Muebles de reposo">Muebles de reposo</option>
