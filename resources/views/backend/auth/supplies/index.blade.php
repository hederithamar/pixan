...
@section ('title', app_name() . ' | ' . __('labels.backend.access.supplies.management'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('labels.backend.access.supplies.management') }} <small class="text-muted">{{ __('labels.backend.access.supplies.active') }}</small>
                </h4>
            </div><!--col-->

            <div class="col-sm-7">
                @include('backend.auth.supplies.includes.header-buttons')
            </div><!--col-->
        </div><!--row-->
        ...
        <div class="row">
            <div class="col-7">
                <div class="float-left">
                    {!! $products->total() !!} {{ trans_choice('labels.backend.access.supplies.table.total', $products->total()) }}
                </div>
            </div><!--col-->
