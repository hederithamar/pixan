                    ...
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                               ...
                               <div class="form-group row">
                                    <div class="col-md-6">
                                        {{ html()->label(__('validation.attributes.backend.access.supplies.lat'))->class('col-md-12 form-control-label')->for('lat') }}
                                    ...
                                    <div class="col-md-6">
                                        {{ html()->label(__('validation.attributes.backend.access.supplies.lng'))->class('col-md-12 form-control-label')->for('lng') }}
