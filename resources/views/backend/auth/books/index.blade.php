...
@section ('title', app_name() . ' | ' . __('labels.backend.access.books.management'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('labels.backend.access.books.management') }} <small class="text-muted">{{ __('labels.backend.access.books.active') }}</small>
                </h4>
            </div><!--col-->

            <div class="col-sm-7">
                @include('backend.auth.books.includes.header-buttons')
            </div><!--col-->
        </div><!--row-->
