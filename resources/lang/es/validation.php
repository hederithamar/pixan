        ...
        'backend' => [
            'access' => [
                ...
                'users' => [
                    ...
                    'language'                => 'Lenguaje',
                    'direccion'            => 'Escriba su ubicación',
                ...
                'furniture' => [
                    'active'             => 'Activo',
                    'name'               => 'El nombre de tu Donación de Muebles',
                    'category'           => 'Categoria',
                    ...
                    'lat'            => 'Tu latitud es:',
                    'lng'            => 'Tu longitud es:',
                    'name_input'               => 'Ej. Cosina',
                    'category_input'           => 'Ej. Muebles',
                    'description_input'        => 'Ej. 2 Sillas, 1 Mesa',
                    'price_input'              => 'Ej. 4 (Usa solo numeros)',
                    'direccion_input'          => 'Ej. 3 Sur Centro Tehuacan, Puebla',
                ...
                'supplies' => [
                    'active'             => 'Activo',
                    'name'               => 'El nombre de tu Donación para utiles escolares',
                    'category'           => 'Categoria',
                    'sub_category'           => 'Sub Categoria',
                    'description'        => 'Descripcion de tu donación',
                    'price'              => '¿Que precio tiene tu producto?',
                    ...
                    'lat'            => 'Tu latitud es:',
                    'lng'            => 'Tu longitud es:',
                    'name_input'               => 'Ej. Calculadoras',
                    'category_input'           => 'Ej. Bebes',
                    'description_input'        => 'Ej. 2 Calculadoras',
                    'price_input'              => 'Ej. 3000 (Usa solo numeros)',
                    'direccion_input'          => 'Ej. 3 Sur Centro Tehuacan, Puebla',
                    'stock_input'              => 'Ej. 4 (Usa solo numeros)',
                    'number_input'              => 'Ej. 3 (Usa solo numeros)',
                ...
                'books' => [
                    'active'             => 'Activo',
                    'name'               => 'El nombre de tu Donación para libros',
                    'category'           => 'Categoria',
                    'sub_category'           => 'Sub Categoria',
                    'description'        => 'Descripcion de tu donación',
                    'price'              => '¿Que precio tiene tu producto?',
                    ...
                    'image_defect'       => 'Imagen por defecto',
                    'status'             => 'Estatus de la donación',
                    'stock'              => '¿Cantidad de libros?',
                    'number_product'     => '¿Cuantos productos son?',
                    'date'               => '¿Que día quieres que pasemos por el?',
                    'hour'               => '¿A que hora estas disponible?',
                    'direccion'            => 'Tu direccion es:',
                    'lat'            => 'Tu latitud es:',
                    'lng'            => 'Tu longitud es:',
                    'name_input'               => 'Ej. Libros escolares',
                    'category_input'           => 'Ej. Bebes',
                    'description_input'        => 'Ej. 2 libros de matemáticas',
                    'price_input'              => 'Ej. 3000 (Usa solo numeros)',
                    'direccion_input'          => 'Ej. 3 Sur Centro Tehuacan, Puebla',
                    'stock_input'              => 'Ej. 4 (Usa solo numeros)',
                    'number_input'              => 'Ej. 3 (Usa solo numeros)',
                ...
                'tools' => [
                    ...
                    'lat'            => 'Tu latitud es:',
                    'lng'            => 'Tu longitud es:',
                    'name_input'               => 'Ej. Rotomartillo',
                    'category_input'           => 'Ej. Herramientas',
                    'description_input'        => 'Ej. 2 Rotomartillos',
                    'price_input'              => 'Ej. 3000 (Usa solo numeros)',
                    'direccion_input'          => 'Ej. 3 Sur Centro Tehuacan, Puebla',
                    'stock_input'              => 'Ej. 4 (Usa solo numeros)',
                    'number_input'              => 'Ej. 3 (Usa solo numeros)',
                 ...
                 'toys' => [
                    'active'             => 'Activo',
                    'name'               => 'El nombre de tu Donación para juguetes',
                    'category'           => 'Categoria',
                    'sub_category'           => 'Sub Categoria',
                    'description'        => 'Descripcion de tu donación',
                    'price'              => '¿Que precio tiene tu producto?',
                    ...
                    'lat'            => 'Tu latitud es:',
                    'lng'            => 'Tu longitud es:',
                    'name_input'               => 'Ej. Juguetes para bebes',
                    'category_input'           => 'Ej. Juguetes',
                    'description_input'        => 'Ej. 2 juguetes vaca musical, Baby blocks',
                    'price_input'              => 'Ej. 3000 (Usa solo numeros)',
                    'direccion_input'          => 'Ej. 3 Sur Centro Tehuacan, Puebla',
                    'stock_input'              => 'Ej. 4 (Usa solo numeros)',
                    'number_input'              => 'Ej. 3 (Usa solo numeros)',
                ...
                'services' => [
                    ...
                    'direccion_input'          => 'Ej. 3 Sur Centro Tehuacan, Puebla',
                    'stock_input'              => 'Ej. 4 (Usa solo numeros)',
                    'number_input'              => 'Eej. 3 (Usa solo numeros)',
                    'date_end_input'              => 'Selecciona una fecha y hora',
