...
namespace App\Http\Controllers\Backend\Auth\Books;
...
class BooksController extends Controller
{
    ...
    {
        return view('backend.auth.books.index')
    ...
    {
        return view('backend.auth.books.create')
    ...
    {   
        ...
        return redirect()->route('admin.auth.donation.books.index')->withFlashSuccess(__('alerts.backend.products.created'));
    }
    ...
    {
        return view('backend.auth.books.show')
            ->withProduct($product);
    }
    ...
    {
        return view('backend.auth.books.edit')
            ->withProduct($product)
            ->withUsers($userRepository->with('permissions')->get());
    }
