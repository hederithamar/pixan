...
namespace App\Http\Controllers\Backend\Auth\Toys;
...
class ToysController extends Controller
{
    ...
    {
        return view('backend.auth.toys.index')
    ...
    {
        return view('backend.auth.toys.create')
    ...
    {   
        ...
        return redirect()->route('admin.auth.donation.toys.index')->withFlashSuccess(__('alerts.backend.products.created'));
    }
    ...
    {
        return view('backend.auth.toys.show')
            ->withProduct($product);
    }
    ...
    {
        return view('backend.auth.toys.edit')
            ->withProduct($product)
            ->withUsers($userRepository->with('permissions')->get());
    }
