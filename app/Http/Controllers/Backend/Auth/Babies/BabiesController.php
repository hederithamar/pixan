...
namespace App\Http\Controllers\Backend\Auth\Babies;
...
class BabiesController extends Controller
{
    ...
    {
        return view('backend.auth.babies.index')
            ->withProducts($this->productRepository->getActiveAuthPaginated(25, 'id', 'asc', 'Bebes'));
    }
    ...
    {
        return view('backend.auth.babies.create')
    ...
    {   
        ...
        return redirect()->route('admin.auth.donation.babies.index')->withFlashSuccess(__('alerts.backend.products.created'));
    }
    ...
    {
        return view('backend.auth.babies.show')
            ->withProduct($product);
    }
    ...
    {
        return view('backend.auth.babies.edit')
            ->withProduct($product)
            ->withUsers($userRepository->with('permissions')->get());
    }
