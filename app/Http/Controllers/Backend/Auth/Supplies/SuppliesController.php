...
namespace App\Http\Controllers\Backend\Auth\Supplies;
...
class SuppliesController extends Controller
{
    ...
    {
        return view('backend.auth.supplies.index')
    ...
    {
        return view('backend.auth.supplies.create')
    ...
    {   
        ...
        return redirect()->route('admin.auth.donation.supplies.index')->withFlashSuccess(__('alerts.backend.products.created'));
    }
    ...
    {
        return view('backend.auth.supplies.show')
            ->withProduct($product);
    }
    ...
    public function edit(Product $product, ManageProductRequest $request, UserRepository $userRepository, PermissionRepository $permissionRepository)
    {
        ...
        return view('backend.auth.supplies.edit')
            ->withProduct($product)
            ->withUsers($userRepository->with('permissions')->get());
    }
