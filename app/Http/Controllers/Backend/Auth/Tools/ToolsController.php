...
namespace App\Http\Controllers\Backend\Auth\Tools;
...
class ToolsController extends Controller
{
    ...
    {
        return view('backend.auth.tools.index')
            ->withProducts($this->productRepository->getActiveAuthPaginated(25, 'id', 'asc', 'Tools')); //Bebes
    }
    ...
    {
        return view('backend.auth.tools.create')
    ...
    {   
        ...
        return redirect()->route('admin.auth.donation.tools.index')->withFlashSuccess(__('alerts.backend.products.created'));
    }
    ...
    {
        return view('backend.auth.tools.show')
            ->withProduct($product);
    }
    ...
    {
        return view('backend.auth.tools.edit')
            ->withProduct($product)
            ->withUsers($userRepository->with('permissions')->get());
    }
